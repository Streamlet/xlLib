...
namespace xl
{
    ...
    public:
        void Intersect(const IntervalType &interval)
        {
            ...
            if (!interval.IsEmpty())
            {
                for (typename Set<IntervalType>::Iterator it = m_setIntervals.Begin(); it != m_setIntervals.End(); ++it)
                {
        ...
        void Union(const IntervalType &interval)
        {
            ...
            for (typename Set<IntervalType>::Iterator it = m_setIntervals.Begin(); it != m_setIntervals.End(); )
            {
    ...
    public:
        IntervalSet Intersection(const IntervalSet &that) const
        {
            ...
            for (typename Set<IntervalType>::Iterator it = that.m_setIntervals.Begin(); it != that.m_setIntervals.End(); ++it)
            {
                res.Intersect(*it);
